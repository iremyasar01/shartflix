...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  RegisterBloc({required AuthService authService})
    ...
    on<RegisterPasswordChanged>((e, emit) => emit(state.copyWith(password: e.password)));
    on<RegisterConfirmPasswordChanged>((e, emit) => emit(state.copyWith(confirmPassword: e.confirmPassword)));
    on<RegisterAgreementChanged>((e, emit) => emit(state.copyWith(isAgreed: e.isAgreed)));
